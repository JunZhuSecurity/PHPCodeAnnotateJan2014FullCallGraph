...
public class Plugin extends AbstractUIPlugin {
	...
	public static HashSet<SensitiveMethod> OrigiRuleSensitiveOperations = new HashSet<SensitiveMethod>(); //all sensitive operations that are defined in the rules are kept in this set.
